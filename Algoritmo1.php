<?php
     ...
     * Si es en Español: remplazamos el guión por un Slash. El Slash escrito en el teclado inglés corresponde al guión en el teclado español.
     */
    function getBarcodeSRC($text, $enEspanol=false, $code_type="code128")
	{
	if (true === $enEspanol) $text = str_ireplace(chr(45), chr(47), $text);
	...
	for ( $position = 1 ; $position <= strlen($code_string); $position++ ) {
		...
		if ( strtolower($orientation) == "horizontal" )
			imagefilledrectangle( $image, $location*$stretch, 0, $cur_size*$stretch, $img_height, ($position % 2 == 0 ? $white : $black) );
		else
			imagefilledrectangle( $image, 0, $location*$stretch, $img_width, $cur_size*$stretch, ($position % 2 == 0 ? $white : $black) );
		$location = $cur_size;
	}
