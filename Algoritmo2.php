<?php
     ...
     * Basado en: https://github.com/waleedahmedwaheed/barcode-api-php
     *
     * Tipo default: code128 (code128b).
...
function getBarcodeSRC($texto, $enEspanol = false) {
        ...
        for ($i = 0, $x = 0, $inc = round($ancho_barra * 100); $i < $enc_str_length; $i++) {
        ...
        $getSRC = @ob_get_clean();
        if (false !== $getSRC) return 'data:image/png;base64,' . base64_encode($getSRC);
        else return '';
    }
